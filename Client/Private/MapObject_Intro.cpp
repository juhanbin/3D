...
CMapObject_Intro::CMapObject_Intro(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CGameObject{ pDevice, pContext }
{
}

CMapObject_Intro::CMapObject_Intro(const CMapObject_Intro& Prototype)
    : CGameObject{ Prototype }
    , m_eType(Prototype.m_eType)
{
}

HRESULT CMapObject_Intro::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CMapObject_Intro::Initialize(void* pArg)
{
...
void CMapObject_Intro::Priority_Update(_float fTimeDelta) {}
void CMapObject_Intro::Update(_float fTimeDelta) {}
void CMapObject_Intro::Late_Update(_float fTimeDelta)
{
...
HRESULT CMapObject_Intro::Render()
{
...
HRESULT CMapObject_Intro::Ready_Components()
{
    // 쉐이더 추가
    ...
    case EObjectType::PEDSTAL:
        modelProto = TEXT("Prototype_Component_Model_MOD_Pedestal");
        break;
...
HRESULT CMapObject_Intro::Bind_ShaderResources()
{
...
CMapObject_Intro* CMapObject_Intro::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CMapObject_Intro* pInstance = new CMapObject_Intro(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed to Created : CMapObject_Intro"));
...
CGameObject* CMapObject_Intro::Clone(void* pArg)
{
    CMapObject_Intro* pInstance = new CMapObject_Intro(*this);
