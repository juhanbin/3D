...
{
public:
    struct Boss_Hand_L_DESC
    {
        EObjectType type{ EObjectType::BOSS_HAND_L };
...
private:
    CBoss_Hand_L(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CBoss_Hand_L(const CBoss_Hand_L& Prototype);
