...
class CWeapon_Skeleton_Arrow final : public CGameObject
{
public:
    struct DESC {
...
private:
    CWeapon_Skeleton_Arrow(ID3D11Device* dev, ID3D11DeviceContext* ctx);
    CWeapon_Skeleton_Arrow(const CWeapon_Skeleton_Arrow& rhs);
    virtual ~CWeapon_Skeleton_Arrow() = default;
...
public:
    static CWeapon_Skeleton_Arrow* Create(ID3D11Device* dev, ID3D11DeviceContext* ctx);
